...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  console.log('==========================================');
  console.log('[EMAILS] DEPRECATED process-submission-new.ts API CALLED - Redirecting to process-submission2.ts');
  console.log('==========================================');
  
  // Log the deprecation warning
  addApiLog('DEPRECATED: process-submission-new.ts API called - Redirecting to process-submission2.ts', 'info', 'emails');
