...
import { Check, Copy, Link, QrCode, Code } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export function ShareFormDialog({ formId }: ShareFormDialogProps) {
  const [copied, setCopied] = useState<string | null>(null);
  const baseUrl = typeof window !== "undefined" ? window.location.origin : "";
  
  const formUrl = `${baseUrl}/forms/${formId}/view`;
